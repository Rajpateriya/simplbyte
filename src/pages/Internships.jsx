              ...
              <div className='box rounded-lg shadow-shadow1 bg-white'>
                ...
                <div className='text p-3'>
                  ...
                  <div className='user flex items-center'>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Est porro quae cum aut magnam maiores sapiente omnis fuga, vel, laborum vitae eligendi fugiat velit reiciendis quis quas. Fuga, ducimus possimus?</p>
                  </div>
                </div>
                <div to='/' className='flex items-center justify-between border-t border-gray-200 p-3'>
                  ...
                  <div className='text-[14px] ml-2 flex items-center'>
                    <a href='https://forms.gle/YVyokv5w2CEgb6AE7' target="_blank">Apply Now</a> <HiOutlineArrowNarrowRight />
                  </div>
                </div>
              </div>
            ))}
